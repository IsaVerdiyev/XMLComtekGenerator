...
{
    class SearchLoansViewModel: ViewModelBase
    {
        ...
        private readonly ISearchLoansXmlGenerator xmlGenerator;
        ...
        public SearchLoansViewModel(INavigator navigator, ISearchLoansXmlGenerator xmlGenerator, NavigationViewModel navigationViewModel)
        {
        ...
        public RelayCommand GenerateXmlCommand
        {
            ...
            {
                XmlResult = xmlGenerator.Generate(PinKod, BankKod, DateTime, Password);
            }));
        }
